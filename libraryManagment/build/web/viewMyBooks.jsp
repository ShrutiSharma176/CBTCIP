...
<%
    ...
    ArrayList<IssuedBook> issue = issueDao.getAllIssuedBookByUSer(user.getId());
    
    ArrayList<Book> myBook = new ArrayList<>();
    for(IssuedBook i : issue){
        myBook.add(new BookDao().getBookDetail(i.getBookId()));
    }
%>
<!DOCTYPE html>
