            ...
            <div class="container">
                <div class="row align-items-center justify-content-between d-flex">
                    ...
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            <li class="menu-active"><a href="userHomePage.jsp">Home</a></li>
                            <li><a href="updatePassword.jsp">Update Password</a></li>
                            <li><a href="viewBook.jsp">View Books</a></li>
                            <li><a href="viewMyBooks.jsp">My Books</a></li>
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="menu-content pb-60 col-lg-8">
                        <div class="title text-center">
                            <h1 class="mb-10">Get Membership you want</h1>
                            <p>Who are in extremely love with eco friendly system.</p>
                        </div>
                    </div>
                </div>						
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="menu-content pb-60 col-lg-9">
                        <div class="title text-center">
                            <h1 class="mb-10">Top Books That are available for Students</h1>
                            <p>Who are in extremely love with eco friendly system.</p>
                        </div>
                    </div>
                </div>						
                <div class="row">
                    <div class="active-course-carusel">
                        <div class="single-course item">
                            ...
                            <div class="details">
                                <a href="#"><h4>Breakthrough Thinking</h4></a>	
                                <p>
                        ...
                        <div class="single-course item">
                            ...
                            <div class="details">
                                <a href="#"><h4>Montages, Toujours!</h4></a>	
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                </p>
                            </div>
                        ...
                        <div class="single-course item">
                            <img class="img-fluid" src="img/c3.jpg" height="412px" alt="">
                            <div class="details">
                                <a href="#"><h4>Harry Potter</h4></a>	
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                </p>
                            </div>
